...
#define kXDebugBoxSrcName(file) [@"XDebugBox.bundle" stringByAppendingPathComponent:file]
#define kXDebugBoxFrameworkSrcName(file) [@"Frameworks/XDebugBox.framework/XDebugBox.bundle" stringByAppendingPathComponent:file]
